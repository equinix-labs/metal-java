...
public class DedicatedPortCreateInput {
  ...
  * @throws IOException if the JSON Element is invalid with respect to DedicatedPortCreateInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DedicatedPortCreateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
