...
public class ProjectIdName {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ProjectIdName
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectIdName.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
