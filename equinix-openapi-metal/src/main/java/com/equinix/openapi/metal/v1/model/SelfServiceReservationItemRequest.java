...
public class SelfServiceReservationItemRequest {
  ...
  **/
   ...
   * @return the SelfServiceReservationItemRequest instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to SelfServiceReservationItemRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SelfServiceReservationItemRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
