...
public class DeviceActionInput {
  ...
  * @throws IOException if the JSON Element is invalid with respect to DeviceActionInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeviceActionInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
