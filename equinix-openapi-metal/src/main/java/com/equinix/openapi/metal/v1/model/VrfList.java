...
public class VrfList {
  ...
  public VrfList addVrfsItem(Vrf vrfsItem) {
    if (this.vrfs == null) {
  ...
  **/
   ...
   * @return the VrfList instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to VrfList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VrfList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("vrfs") != null && !jsonObj.get("vrfs").isJsonNull()) {
        ...
        if (jsonArrayvrfs != null) {
          ...
          for (int i = 0; i < jsonArrayvrfs.size(); i++) {
            Vrf.validateJsonElement(jsonArrayvrfs.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VrfList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VrfList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VrfList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VrfList.class));

       return (TypeAdapter<T>) new TypeAdapter<VrfList>() {
           @Override
 ...
 /**
  * Create an instance of VrfList given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VrfList
  * @throws IOException if the JSON string is invalid with respect to VrfList
  */
  public static VrfList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VrfList.class);
  }

 /**
  * Convert an instance of VrfList to an JSON string
  *
  * @return JSON string
  */
