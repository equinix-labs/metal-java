...
public class VrfCreateInput {
  ...
  * @throws IOException if the JSON Element is invalid with respect to VrfCreateInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VrfCreateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
