...
import com.equinix.openapi.metal.v1.model.Disk;
import com.equinix.openapi.metal.v1.model.Filesystem;
import com.equinix.openapi.metal.v1.model.Raid;
...
public class Storage {
  ...
  public Storage disks(List<Disk> disks) {
    
    this.disks = disks;
    return this;
  }

  public Storage addDisksItem(Disk disksItem) {
    if (this.disks == null) {
  ...
  **/
  ...
  public Storage raid(List<Raid> raid) {
    
    this.raid = raid;
    return this;
  }

  public Storage addRaidItem(Raid raidItem) {
    if (this.raid == null) {
  ...
  **/
  ...
  public Storage filesystems(List<Filesystem> filesystems) {
    
    this.filesystems = filesystems;
    return this;
  }

  public Storage addFilesystemsItem(Filesystem filesystemsItem) {
  ...
  **/
   ...
   * @return the Storage instance itself
   */
  public Storage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.disks, storage.disks) &&
        Objects.equals(this.raid, storage.raid) &&
        Objects.equals(this.filesystems, storage.filesystems)&&
        Objects.equals(this.additionalProperties, storage.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(disks, raid, filesystems, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to Storage
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Storage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("raid") != null && !jsonObj.get("raid").isJsonNull()) {
        ...
        if (jsonArrayraid != null) {
          ...
          if (!jsonObj.get("raid").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `raid` to be an array in the JSON string but got `%s`", jsonObj.get("raid").toString()));
          }

          // validate the optional field `raid` (array)
          for (int i = 0; i < jsonArrayraid.size(); i++) {
            Raid.validateJsonElement(jsonArrayraid.get(i));
          };
        }
      }
      if (jsonObj.get("filesystems") != null && !jsonObj.get("filesystems").isJsonNull()) {
        ...
        if (jsonArrayfilesystems != null) {
          ...
          for (int i = 0; i < jsonArrayfilesystems.size(); i++) {
            Filesystem.validateJsonElement(jsonArrayfilesystems.get(i));
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Storage>() {
           ...
           public Storage read(JsonReader in) throws IOException {
             ...
             Storage instance = thisAdapter.fromJsonTree(jsonObj);
