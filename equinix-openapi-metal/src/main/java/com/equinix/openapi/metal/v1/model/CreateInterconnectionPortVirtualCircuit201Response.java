...
public class CreateInterconnectionPortVirtualCircuit201Response extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateInterconnectionPortVirtualCircuit201Response.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateInterconnectionPortVirtualCircuit201Response.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateInterconnectionPortVirtualCircuit201Response' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateInterconnectionPortVirtualCircuit201Response>() {
                @Override
                public void write(JsonWriter out, CreateInterconnectionPortVirtualCircuit201Response value) throws IOException {
                ...
                @Override
                public CreateInterconnectionPortVirtualCircuit201Response read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateInterconnectionPortVirtualCircuit201Response ret = new CreateInterconnectionPortVirtualCircuit201Response();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CreateInterconnectionPortVirtualCircuit201Response: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateInterconnectionPortVirtualCircuit201Response() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateInterconnectionPortVirtualCircuit201Response(VirtualCircuit o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateInterconnectionPortVirtualCircuit201Response(VrfVirtualCircuit o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CreateInterconnectionPortVirtualCircuit201Response.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateInterconnectionPortVirtualCircuit201Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreateInterconnectionPortVirtualCircuit201Response with oneOf schemas: VirtualCircuit, VrfVirtualCircuit. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of CreateInterconnectionPortVirtualCircuit201Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateInterconnectionPortVirtualCircuit201Response
  * @throws IOException if the JSON string is invalid with respect to CreateInterconnectionPortVirtualCircuit201Response
  */
  public static CreateInterconnectionPortVirtualCircuit201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateInterconnectionPortVirtualCircuit201Response.class);
  }

 /**
  * Convert an instance of CreateInterconnectionPortVirtualCircuit201Response to an JSON string
  *
  * @return JSON string
  */
