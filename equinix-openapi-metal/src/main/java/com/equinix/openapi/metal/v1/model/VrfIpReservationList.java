...
public class VrfIpReservationList {
  ...
  private List<VrfIpReservation> ipAddresses;
  ...
  * @throws IOException if the JSON Element is invalid with respect to VrfIpReservationList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VrfIpReservationList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("ip_addresses") != null && !jsonObj.get("ip_addresses").isJsonNull()) {
        ...
        if (jsonArrayipAddresses != null) {
          ...
          for (int i = 0; i < jsonArrayipAddresses.size(); i++) {
            VrfIpReservation.validateJsonElement(jsonArrayipAddresses.get(i));
          };
        }
      }
  }
