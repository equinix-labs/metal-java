...
public class VirtualNetworkCreateInput {
  ...
  **/
  ...
  public VirtualNetworkCreateInput tags(List<String> tags) {
    
    this.tags = tags;
    return this;
  }

  public VirtualNetworkCreateInput addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, virtualNetworkCreateInput.description) &&
        ...
        Objects.equals(this.tags, virtualNetworkCreateInput.tags)&&
        Objects.equals(this.additionalProperties, virtualNetworkCreateInput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, facility, metro, vxlan, tags, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to VirtualNetworkCreateInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VirtualNetworkCreateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
