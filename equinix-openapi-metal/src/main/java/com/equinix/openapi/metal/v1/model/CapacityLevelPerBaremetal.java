...
public class CapacityLevelPerBaremetal {
  ...
  **/
   ...
   * @return the CapacityLevelPerBaremetal instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to CapacityLevelPerBaremetal
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CapacityLevelPerBaremetal.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
