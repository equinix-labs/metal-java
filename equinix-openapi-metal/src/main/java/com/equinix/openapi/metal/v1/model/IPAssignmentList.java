...
public class IPAssignmentList {
  ...
  **/
   ...
   * @return the IPAssignmentList instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to IPAssignmentList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IPAssignmentList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
