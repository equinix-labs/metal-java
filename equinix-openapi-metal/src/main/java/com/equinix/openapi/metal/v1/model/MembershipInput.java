...
public class MembershipInput {
  ...
  **/
   ...
   * @return the MembershipInput instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to MembershipInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MembershipInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MembershipInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MembershipInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MembershipInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MembershipInput.class));

       return (TypeAdapter<T>) new TypeAdapter<MembershipInput>() {
           @Override
 ...
 /**
  * Create an instance of MembershipInput given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MembershipInput
  * @throws IOException if the JSON string is invalid with respect to MembershipInput
  */
  public static MembershipInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MembershipInput.class);
  }

 /**
  * Convert an instance of MembershipInput to an JSON string
  *
  * @return JSON string
  */
