...
public class BgpDynamicNeighborCreateInput {
  ...
  * @throws IOException if the JSON Element is invalid with respect to BgpDynamicNeighborCreateInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BgpDynamicNeighborCreateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
