...
public class VrfRouteUpdateInput {
  ...
  * @throws IOException if the JSON Element is invalid with respect to VrfRouteUpdateInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VrfRouteUpdateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
