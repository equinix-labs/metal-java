...
import com.equinix.openapi.metal.v1.model.PortVlanAssignmentBatchCreateInputVlanAssignmentsInner;
...
public class PortVlanAssignmentBatchCreateInput {
  ...
  private List<PortVlanAssignmentBatchCreateInputVlanAssignmentsInner> vlanAssignments;
  ...
  public PortVlanAssignmentBatchCreateInput addVlanAssignmentsItem(PortVlanAssignmentBatchCreateInputVlanAssignmentsInner vlanAssignmentsItem) {
  ...
  **/
  ...
  public List<PortVlanAssignmentBatchCreateInputVlanAssignmentsInner> getVlanAssignments() {
    return vlanAssignments;
  }


  public void setVlanAssignments(List<PortVlanAssignmentBatchCreateInputVlanAssignmentsInner> vlanAssignments) {
    this.vlanAssignments = vlanAssignments;
  }
   ...
   * @return the PortVlanAssignmentBatchCreateInput instance itself
   */
  ...
  * @throws IOException if the JSON Object is invalid with respect to PortVlanAssignmentBatchCreateInput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PortVlanAssignmentBatchCreateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("vlan_assignments") != null && !jsonObj.get("vlan_assignments").isJsonNull()) {
        ...
        if (jsonArrayvlanAssignments != null) {
          ...
          for (int i = 0; i < jsonArrayvlanAssignments.size(); i++) {
            PortVlanAssignmentBatchCreateInputVlanAssignmentsInner.validateJsonObject(jsonArrayvlanAssignments.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PortVlanAssignmentBatchCreateInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PortVlanAssignmentBatchCreateInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PortVlanAssignmentBatchCreateInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PortVlanAssignmentBatchCreateInput.class));

       return (TypeAdapter<T>) new TypeAdapter<PortVlanAssignmentBatchCreateInput>() {
           @Override
 ...
 /**
  * Create an instance of PortVlanAssignmentBatchCreateInput given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PortVlanAssignmentBatchCreateInput
  * @throws IOException if the JSON string is invalid with respect to PortVlanAssignmentBatchCreateInput
  */
  public static PortVlanAssignmentBatchCreateInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PortVlanAssignmentBatchCreateInput.class);
  }

 /**
  * Convert an instance of PortVlanAssignmentBatchCreateInput to an JSON string
  *
  * @return JSON string
  */
