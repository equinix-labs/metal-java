...
public class PortVlanAssignmentBatchList {
  ...
  public PortVlanAssignmentBatchList addBatchesItem(PortVlanAssignmentBatch batchesItem) {
  ...
  **/
  ...
  public List<PortVlanAssignmentBatch> getBatches() {
    return batches;
  }


  public void setBatches(List<PortVlanAssignmentBatch> batches) {
    this.batches = batches;
  }
   ...
   * @return the PortVlanAssignmentBatchList instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to PortVlanAssignmentBatchList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PortVlanAssignmentBatchList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("batches") != null && !jsonObj.get("batches").isJsonNull()) {
        ...
        if (jsonArraybatches != null) {
          ...
          for (int i = 0; i < jsonArraybatches.size(); i++) {
            PortVlanAssignmentBatch.validateJsonElement(jsonArraybatches.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PortVlanAssignmentBatchList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PortVlanAssignmentBatchList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PortVlanAssignmentBatchList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PortVlanAssignmentBatchList.class));

       return (TypeAdapter<T>) new TypeAdapter<PortVlanAssignmentBatchList>() {
           @Override
 ...
 /**
  * Create an instance of PortVlanAssignmentBatchList given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PortVlanAssignmentBatchList
  * @throws IOException if the JSON string is invalid with respect to PortVlanAssignmentBatchList
  */
  public static PortVlanAssignmentBatchList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PortVlanAssignmentBatchList.class);
  }

 /**
  * Convert an instance of PortVlanAssignmentBatchList to an JSON string
  *
  * @return JSON string
  */
