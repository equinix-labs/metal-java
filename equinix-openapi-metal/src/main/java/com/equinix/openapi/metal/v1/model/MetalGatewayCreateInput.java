...
public class MetalGatewayCreateInput {
  ...
  * @throws IOException if the JSON Element is invalid with respect to MetalGatewayCreateInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetalGatewayCreateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
