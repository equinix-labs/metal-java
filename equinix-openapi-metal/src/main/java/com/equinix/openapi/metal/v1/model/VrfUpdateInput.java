...
public class VrfUpdateInput {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bgpDynamicNeighborsEnabled, bgpDynamicNeighborsExportRouteMap, bgpDynamicNeighborsBfdEnabled, description, ipRanges, localAsn, name, additionalProperties);
  }
