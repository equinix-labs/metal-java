...
public class License {
  ...
  public static final String SERIALIZED_NAME_LICENSEE_PRODUCT = "licensee_product";
  @SerializedName(SERIALIZED_NAME_LICENSEE_PRODUCT)
  private Href licenseeProduct;
  ...
  **/
   ...
   * @return the License instance itself
   */
  ...
  static {
    ...
    openapiFields.add("licensee_product");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("licensee_product") != null && !jsonObj.get("licensee_product").isJsonNull()) {
        Href.validateJsonElement(jsonObj.get("licensee_product"));
      }
