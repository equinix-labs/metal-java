...
public class Facility {
  ...
  **/
  ...
  public Facility metro(DeviceMetro metro) {
  ...
  **/
   ...
   * @return the Facility instance itself
   */
  ...
  * @throws IOException if the JSON Object is invalid with respect to Facility
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Facility.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
