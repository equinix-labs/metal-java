...
public class IPReservationRequestInput {
  ...
  **/
   ...
   * @return the IPReservationRequestInput instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to IPReservationRequestInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IPReservationRequestInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
