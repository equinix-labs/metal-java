...
public class DeviceCreateInMetroInput {
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeviceCreateInMetroInput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeviceCreateInMetroInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
