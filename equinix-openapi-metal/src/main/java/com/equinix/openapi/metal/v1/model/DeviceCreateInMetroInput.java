...
public class DeviceCreateInMetroInput {
  ...
  public DeviceCreateInMetroInput() {
  }

  public DeviceCreateInMetroInput metro(String metro) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput alwaysPxe(Boolean alwaysPxe) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput billingCycle(BillingCycleEnum billingCycle) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput customdata(Map<String, Object> customdata) {
    
    this.customdata = customdata;
    return this;
  }

  public DeviceCreateInMetroInput putCustomdataItem(String key, Object customdataItem) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput description(String description) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput features(List<String> features) {
    
    this.features = features;
    return this;
  }

  public DeviceCreateInMetroInput addFeaturesItem(String featuresItem) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput hardwareReservationId(String hardwareReservationId) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput hostname(String hostname) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput ipAddresses(List<IPAddress> ipAddresses) {
    
    this.ipAddresses = ipAddresses;
    return this;
  }

  public DeviceCreateInMetroInput addIpAddressesItem(IPAddress ipAddressesItem) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput ipxeScriptUrl(String ipxeScriptUrl) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput locked(Boolean locked) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput networkFrozen(Boolean networkFrozen) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput noSshKeys(Boolean noSshKeys) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput operatingSystem(String operatingSystem) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput plan(String plan) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput privateIpv4SubnetSize(Integer privateIpv4SubnetSize) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput projectSshKeys(List<UUID> projectSshKeys) {
    
    this.projectSshKeys = projectSshKeys;
    return this;
  }

  public DeviceCreateInMetroInput addProjectSshKeysItem(UUID projectSshKeysItem) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput publicIpv4SubnetSize(Integer publicIpv4SubnetSize) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput spotInstance(Boolean spotInstance) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput spotPriceMax(Float spotPriceMax) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput sshKeys(List<SSHKeyInput> sshKeys) {
    
    this.sshKeys = sshKeys;
    return this;
  }

  public DeviceCreateInMetroInput addSshKeysItem(SSHKeyInput sshKeysItem) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput storage(Storage storage) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput tags(List<String> tags) {
    
    this.tags = tags;
    return this;
  }

  public DeviceCreateInMetroInput addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput terminationTime(OffsetDateTime terminationTime) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput userSshKeys(List<UUID> userSshKeys) {
    
    this.userSshKeys = userSshKeys;
    return this;
  }

  public DeviceCreateInMetroInput addUserSshKeysItem(UUID userSshKeysItem) {
  ...
  **/
  ...
  public DeviceCreateInMetroInput userdata(String userdata) {
  ...
  **/
   ...
   * @return the DeviceCreateInMetroInput instance itself
   */
  public DeviceCreateInMetroInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DeviceCreateInMetroInput deviceCreateInMetroInput = (DeviceCreateInMetroInput) o;
    return Objects.equals(this.metro, deviceCreateInMetroInput.metro) &&
        Objects.equals(this.alwaysPxe, deviceCreateInMetroInput.alwaysPxe) &&
        Objects.equals(this.billingCycle, deviceCreateInMetroInput.billingCycle) &&
        Objects.equals(this.customdata, deviceCreateInMetroInput.customdata) &&
        Objects.equals(this.description, deviceCreateInMetroInput.description) &&
        Objects.equals(this.features, deviceCreateInMetroInput.features) &&
        Objects.equals(this.hardwareReservationId, deviceCreateInMetroInput.hardwareReservationId) &&
        Objects.equals(this.hostname, deviceCreateInMetroInput.hostname) &&
        Objects.equals(this.ipAddresses, deviceCreateInMetroInput.ipAddresses) &&
        Objects.equals(this.ipxeScriptUrl, deviceCreateInMetroInput.ipxeScriptUrl) &&
        Objects.equals(this.locked, deviceCreateInMetroInput.locked) &&
        Objects.equals(this.networkFrozen, deviceCreateInMetroInput.networkFrozen) &&
        Objects.equals(this.noSshKeys, deviceCreateInMetroInput.noSshKeys) &&
        Objects.equals(this.operatingSystem, deviceCreateInMetroInput.operatingSystem) &&
        Objects.equals(this.plan, deviceCreateInMetroInput.plan) &&
        Objects.equals(this.privateIpv4SubnetSize, deviceCreateInMetroInput.privateIpv4SubnetSize) &&
        Objects.equals(this.projectSshKeys, deviceCreateInMetroInput.projectSshKeys) &&
        Objects.equals(this.publicIpv4SubnetSize, deviceCreateInMetroInput.publicIpv4SubnetSize) &&
        Objects.equals(this.spotInstance, deviceCreateInMetroInput.spotInstance) &&
        Objects.equals(this.spotPriceMax, deviceCreateInMetroInput.spotPriceMax) &&
        Objects.equals(this.sshKeys, deviceCreateInMetroInput.sshKeys) &&
        Objects.equals(this.storage, deviceCreateInMetroInput.storage) &&
        Objects.equals(this.tags, deviceCreateInMetroInput.tags) &&
        Objects.equals(this.terminationTime, deviceCreateInMetroInput.terminationTime) &&
        Objects.equals(this.userSshKeys, deviceCreateInMetroInput.userSshKeys) &&
        Objects.equals(this.userdata, deviceCreateInMetroInput.userdata)&&
        Objects.equals(this.additionalProperties, deviceCreateInMetroInput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metro, alwaysPxe, billingCycle, customdata, description, features, hardwareReservationId, hostname, ipAddresses, ipxeScriptUrl, locked, networkFrozen, noSshKeys, operatingSystem, plan, privateIpv4SubnetSize, projectSshKeys, publicIpv4SubnetSize, spotInstance, spotPriceMax, sshKeys, storage, tags, terminationTime, userSshKeys, userdata, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeviceCreateInMetroInput {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to DeviceCreateInMetroInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeviceCreateInMetroInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeviceCreateInMetroInput is not found in the empty JSON string", DeviceCreateInMetroInput.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeviceCreateInMetroInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeviceCreateInMetroInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeviceCreateInMetroInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeviceCreateInMetroInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeviceCreateInMetroInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeviceCreateInMetroInput>() {
           @Override
           public void write(JsonWriter out, DeviceCreateInMetroInput value) throws IOException {
           ...
           @Override
           public DeviceCreateInMetroInput read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DeviceCreateInMetroInput instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DeviceCreateInMetroInput given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeviceCreateInMetroInput
  * @throws IOException if the JSON string is invalid with respect to DeviceCreateInMetroInput
  */
  public static DeviceCreateInMetroInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeviceCreateInMetroInput.class);
  }

 /**
  * Convert an instance of DeviceCreateInMetroInput to an JSON string
  *
  * @return JSON string
  */
