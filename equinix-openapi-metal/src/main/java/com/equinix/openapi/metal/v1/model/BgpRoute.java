...
public class BgpRoute {
  ...
  * @throws IOException if the JSON Element is invalid with respect to BgpRoute
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BgpRoute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
