...
public class CapacityCheckPerMetroList {
  ...
  private List<CapacityCheckPerMetroInfo> servers;
  ...
  * @throws IOException if the JSON Element is invalid with respect to CapacityCheckPerMetroList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CapacityCheckPerMetroList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("servers") != null && !jsonObj.get("servers").isJsonNull()) {
        ...
        if (jsonArrayservers != null) {
          ...
          for (int i = 0; i < jsonArrayservers.size(); i++) {
            CapacityCheckPerMetroInfo.validateJsonElement(jsonArrayservers.get(i));
          };
        }
      }
  }
