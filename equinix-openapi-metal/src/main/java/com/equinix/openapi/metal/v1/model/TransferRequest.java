...
public class TransferRequest {
  ...
  public static final String SERIALIZED_NAME_TARGET_ORGANIZATION = "target_organization";
  @SerializedName(SERIALIZED_NAME_TARGET_ORGANIZATION)
  private Href targetOrganization;
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("target_organization");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("target_organization") != null && !jsonObj.get("target_organization").isJsonNull()) {
        Href.validateJsonElement(jsonObj.get("target_organization"));
      }
  }
