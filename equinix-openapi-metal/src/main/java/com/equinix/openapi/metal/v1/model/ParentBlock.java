...
public class ParentBlock {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ParentBlock
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ParentBlock.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
