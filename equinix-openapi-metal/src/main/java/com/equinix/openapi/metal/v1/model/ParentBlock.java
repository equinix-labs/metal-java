...
public class ParentBlock {
  ...
  **/
   ...
   * @return the ParentBlock instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to ParentBlock
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ParentBlock.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ParentBlock.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ParentBlock' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ParentBlock> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ParentBlock.class));

       return (TypeAdapter<T>) new TypeAdapter<ParentBlock>() {
           @Override
 ...
 /**
  * Create an instance of ParentBlock given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ParentBlock
  * @throws IOException if the JSON string is invalid with respect to ParentBlock
  */
  public static ParentBlock fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ParentBlock.class);
  }

 /**
  * Convert an instance of ParentBlock to an JSON string
  *
  * @return JSON string
  */
