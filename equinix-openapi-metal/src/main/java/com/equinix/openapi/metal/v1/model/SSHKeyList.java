...
public class SSHKeyList {
  ...
  **/
   ...
   * @return the SSHKeyList instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to SSHKeyList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SSHKeyList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
