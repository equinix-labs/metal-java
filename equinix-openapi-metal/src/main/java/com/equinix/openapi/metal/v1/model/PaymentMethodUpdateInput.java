...
public class PaymentMethodUpdateInput {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PaymentMethodUpdateInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentMethodUpdateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
