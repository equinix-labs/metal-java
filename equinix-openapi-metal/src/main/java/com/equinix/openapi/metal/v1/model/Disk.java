...
import com.equinix.openapi.metal.v1.model.Partition;
...
public class Disk {
  ...
  public static final String SERIALIZED_NAME_WIPE_TABLE = "wipeTable";
  @SerializedName(SERIALIZED_NAME_WIPE_TABLE)
  private Boolean wipeTable;
  ...
  **/
  ...
  public Disk wipeTable(Boolean wipeTable) {
    
    this.wipeTable = wipeTable;
    return this;
  }
  ...
  **/
  ...
  public void setWipeTable(Boolean wipeTable) {
    this.wipeTable = wipeTable;
  }
  ...
  **/
   ...
   * @return the Disk instance itself
   */
  public Disk putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Disk disk = (Disk) o;
    return Objects.equals(this.device, disk.device) &&
        Objects.equals(this.wipeTable, disk.wipeTable) &&
        Objects.equals(this.partitions, disk.partitions)&&
        Objects.equals(this.additionalProperties, disk.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(device, wipeTable, partitions, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Disk
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Disk.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("partitions") != null && !jsonObj.get("partitions").isJsonNull()) {
        ...
        if (jsonArraypartitions != null) {
          ...
          for (int i = 0; i < jsonArraypartitions.size(); i++) {
            Partition.validateJsonObject(jsonArraypartitions.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Disk>() {
           ...
           public Disk read(JsonReader in) throws IOException {
             ...
             Disk instance = thisAdapter.fromJsonTree(jsonObj);
