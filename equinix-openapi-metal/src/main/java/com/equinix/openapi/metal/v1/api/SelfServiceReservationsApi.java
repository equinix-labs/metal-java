...
public class SelfServiceReservationsApi {
     ...
     * @param createSelfServiceReservationRequest reservation to create (required)
     ...
     */
    public okhttp3.Call createSelfServiceReservationCall(UUID projectId, CreateSelfServiceReservationRequest createSelfServiceReservationRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = createSelfServiceReservationRequest;
     ...
     */
    public SelfServiceReservationResponse createSelfServiceReservation(UUID projectId, CreateSelfServiceReservationRequest createSelfServiceReservationRequest) throws ApiException {
        ApiResponse<SelfServiceReservationResponse> localVarResp = createSelfServiceReservationWithHttpInfo(projectId, createSelfServiceReservationRequest);
     ...
     */
    public ApiResponse<SelfServiceReservationResponse> createSelfServiceReservationWithHttpInfo(UUID projectId, CreateSelfServiceReservationRequest createSelfServiceReservationRequest) throws ApiException {
        okhttp3.Call localVarCall = createSelfServiceReservationValidateBeforeCall(projectId, createSelfServiceReservationRequest, null);
     ...
     */
    public okhttp3.Call createSelfServiceReservationAsync(UUID projectId, CreateSelfServiceReservationRequest createSelfServiceReservationRequest, final ApiCallback<SelfServiceReservationResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = createSelfServiceReservationValidateBeforeCall(projectId, createSelfServiceReservationRequest, _callback);
        Type localVarReturnType = new TypeToken<SelfServiceReservationResponse>(){}.getType();
     ...
     */
    public okhttp3.Call findSelfServiceReservationCall(UUID id, UUID projectId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    public SelfServiceReservationResponse findSelfServiceReservation(UUID id, UUID projectId) throws ApiException {
        ApiResponse<SelfServiceReservationResponse> localVarResp = findSelfServiceReservationWithHttpInfo(id, projectId);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<SelfServiceReservationResponse> findSelfServiceReservationWithHttpInfo(UUID id, UUID projectId) throws ApiException {
        okhttp3.Call localVarCall = findSelfServiceReservationValidateBeforeCall(id, projectId, null);
        Type localVarReturnType = new TypeToken<SelfServiceReservationResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call findSelfServiceReservationAsync(UUID id, UUID projectId, final ApiCallback<SelfServiceReservationResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = findSelfServiceReservationValidateBeforeCall(id, projectId, _callback);
        Type localVarReturnType = new TypeToken<SelfServiceReservationResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
