...
public class IPAvailabilitiesList {
  ...
  **/
   ...
   * @return the IPAvailabilitiesList instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to IPAvailabilitiesList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IPAvailabilitiesList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IPAvailabilitiesList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IPAvailabilitiesList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IPAvailabilitiesList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IPAvailabilitiesList.class));

       return (TypeAdapter<T>) new TypeAdapter<IPAvailabilitiesList>() {
           @Override
 ...
 /**
  * Create an instance of IPAvailabilitiesList given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IPAvailabilitiesList
  * @throws IOException if the JSON string is invalid with respect to IPAvailabilitiesList
  */
  public static IPAvailabilitiesList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IPAvailabilitiesList.class);
  }

 /**
  * Convert an instance of IPAvailabilitiesList to an JSON string
  *
  * @return JSON string
  */
