...
public class FacilityList {
  ...
  * @throws IOException if the JSON Element is invalid with respect to FacilityList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FacilityList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
