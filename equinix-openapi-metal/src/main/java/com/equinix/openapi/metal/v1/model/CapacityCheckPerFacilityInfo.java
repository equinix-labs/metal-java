...
public class CapacityCheckPerFacilityInfo {
  ...
  **/
   ...
   * @return the CapacityCheckPerFacilityInfo instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to CapacityCheckPerFacilityInfo
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CapacityCheckPerFacilityInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
