...
public class BatchesList {
  ...
  **/
   ...
   * @return the BatchesList instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to BatchesList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchesList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchesList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchesList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchesList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchesList.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchesList>() {
           @Override
 ...
 /**
  * Create an instance of BatchesList given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BatchesList
  * @throws IOException if the JSON string is invalid with respect to BatchesList
  */
  public static BatchesList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchesList.class);
  }

 /**
  * Convert an instance of BatchesList to an JSON string
  *
  * @return JSON string
  */
