...
public class MetalGatewaysApi {
     ...
     */
    public void deleteMetalGateway(UUID id, List<String> include, List<String> exclude) throws ApiException {
        deleteMetalGatewayWithHttpInfo(id, include, exclude);
    }
     ...
     */
    public ApiResponse<Void> deleteMetalGatewayWithHttpInfo(UUID id, List<String> include, List<String> exclude) throws ApiException {
     ...
     */
    public okhttp3.Call deleteMetalGatewayAsync(UUID id, List<String> include, List<String> exclude, final ApiCallback<Void> _callback) throws ApiException {
