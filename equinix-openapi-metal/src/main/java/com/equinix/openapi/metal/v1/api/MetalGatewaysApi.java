...
public class MetalGatewaysApi {
     ...
     */
    public okhttp3.Call createMetalGatewayElasticIpCall(UUID id, MetalGatewayElasticIpCreateInput metalGatewayElasticIpCreateInput, List<String> include, List<String> exclude, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createMetalGatewayElasticIpValidateBeforeCall(UUID id, MetalGatewayElasticIpCreateInput metalGatewayElasticIpCreateInput, List<String> include, List<String> exclude, final ApiCallback _callback) throws ApiException {
        ...
        return createMetalGatewayElasticIpCall(id, metalGatewayElasticIpCreateInput, include, exclude, _callback);
     ...
     */
    public IPAssignment createMetalGatewayElasticIp(UUID id, MetalGatewayElasticIpCreateInput metalGatewayElasticIpCreateInput, List<String> include, List<String> exclude) throws ApiException {
        ApiResponse<IPAssignment> localVarResp = createMetalGatewayElasticIpWithHttpInfo(id, metalGatewayElasticIpCreateInput, include, exclude);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<IPAssignment> createMetalGatewayElasticIpWithHttpInfo(UUID id, MetalGatewayElasticIpCreateInput metalGatewayElasticIpCreateInput, List<String> include, List<String> exclude) throws ApiException {
        okhttp3.Call localVarCall = createMetalGatewayElasticIpValidateBeforeCall(id, metalGatewayElasticIpCreateInput, include, exclude, null);
     ...
     */
    public okhttp3.Call createMetalGatewayElasticIpAsync(UUID id, MetalGatewayElasticIpCreateInput metalGatewayElasticIpCreateInput, List<String> include, List<String> exclude, final ApiCallback<IPAssignment> _callback) throws ApiException {

        okhttp3.Call localVarCall = createMetalGatewayElasticIpValidateBeforeCall(id, metalGatewayElasticIpCreateInput, include, exclude, _callback);
        Type localVarReturnType = new TypeToken<IPAssignment>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
