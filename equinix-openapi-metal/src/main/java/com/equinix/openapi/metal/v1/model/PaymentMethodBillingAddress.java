...
public class PaymentMethodBillingAddress {
  ...
  **/
   ...
   * @return the PaymentMethodBillingAddress instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to PaymentMethodBillingAddress
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentMethodBillingAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
