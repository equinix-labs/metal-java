...
public class ProjectCreateInput {
  ...
  **/
  ...
  public ProjectCreateInput tags(List<String> tags) {
    
    this.tags = tags;
    return this;
  }

  public ProjectCreateInput addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ProjectCreateInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectCreateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
