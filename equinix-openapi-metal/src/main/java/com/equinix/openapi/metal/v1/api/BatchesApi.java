...
public class BatchesApi {
     ...
     */
    public okhttp3.Call findBatchByIdCall(UUID id, List<String> include, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call findBatchByIdValidateBeforeCall(UUID id, List<String> include, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling findBatchById(Async)");
        }

        return findBatchByIdCall(id, include, _callback);
     ...
     */
    public Batch findBatchById(UUID id, List<String> include) throws ApiException {
        ApiResponse<Batch> localVarResp = findBatchByIdWithHttpInfo(id, include);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Batch> findBatchByIdWithHttpInfo(UUID id, List<String> include) throws ApiException {
        okhttp3.Call localVarCall = findBatchByIdValidateBeforeCall(id, include, null);
     ...
     */
    public okhttp3.Call findBatchByIdAsync(UUID id, List<String> include, final ApiCallback<Batch> _callback) throws ApiException {

        okhttp3.Call localVarCall = findBatchByIdValidateBeforeCall(id, include, _callback);
        Type localVarReturnType = new TypeToken<Batch>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call findBatchesByProjectCall(UUID id, List<String> include, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call findBatchesByProjectValidateBeforeCall(UUID id, List<String> include, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling findBatchesByProject(Async)");
        }

        return findBatchesByProjectCall(id, include, _callback);
     ...
     */
    public BatchesList findBatchesByProject(UUID id, List<String> include) throws ApiException {
        ApiResponse<BatchesList> localVarResp = findBatchesByProjectWithHttpInfo(id, include);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<BatchesList> findBatchesByProjectWithHttpInfo(UUID id, List<String> include) throws ApiException {
        okhttp3.Call localVarCall = findBatchesByProjectValidateBeforeCall(id, include, null);
        Type localVarReturnType = new TypeToken<BatchesList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call findBatchesByProjectAsync(UUID id, List<String> include, final ApiCallback<BatchesList> _callback) throws ApiException {

        okhttp3.Call localVarCall = findBatchesByProjectValidateBeforeCall(id, include, _callback);
        Type localVarReturnType = new TypeToken<BatchesList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
