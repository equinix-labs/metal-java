...
public class DeviceCreatedBy {
  ...
  * @throws IOException if the JSON Element is invalid with respect to DeviceCreatedBy
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeviceCreatedBy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
