...
public class PaymentMethodsApi {
     ...
     */
    public okhttp3.Call findPaymentMethodByIdCall(UUID id, List<String> include, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call findPaymentMethodByIdValidateBeforeCall(UUID id, List<String> include, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling findPaymentMethodById(Async)");
        }

        return findPaymentMethodByIdCall(id, include, _callback);
     ...
     */
    public PaymentMethod findPaymentMethodById(UUID id, List<String> include) throws ApiException {
        ApiResponse<PaymentMethod> localVarResp = findPaymentMethodByIdWithHttpInfo(id, include);
     ...
     */
    public ApiResponse<PaymentMethod> findPaymentMethodByIdWithHttpInfo(UUID id, List<String> include) throws ApiException {
        okhttp3.Call localVarCall = findPaymentMethodByIdValidateBeforeCall(id, include, null);
     ...
     */
    public okhttp3.Call findPaymentMethodByIdAsync(UUID id, List<String> include, final ApiCallback<PaymentMethod> _callback) throws ApiException {

        okhttp3.Call localVarCall = findPaymentMethodByIdValidateBeforeCall(id, include, _callback);
        Type localVarReturnType = new TypeToken<PaymentMethod>(){}.getType();
     ...
     */
    public okhttp3.Call updatePaymentMethodCall(UUID id, PaymentMethodUpdateInput paymentMethodUpdateInput, List<String> include, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updatePaymentMethodValidateBeforeCall(UUID id, PaymentMethodUpdateInput paymentMethodUpdateInput, List<String> include, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
        ...
        return updatePaymentMethodCall(id, paymentMethodUpdateInput, include, _callback);
     ...
     */
    public PaymentMethod updatePaymentMethod(UUID id, PaymentMethodUpdateInput paymentMethodUpdateInput, List<String> include) throws ApiException {
        ApiResponse<PaymentMethod> localVarResp = updatePaymentMethodWithHttpInfo(id, paymentMethodUpdateInput, include);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PaymentMethod> updatePaymentMethodWithHttpInfo(UUID id, PaymentMethodUpdateInput paymentMethodUpdateInput, List<String> include) throws ApiException {
        okhttp3.Call localVarCall = updatePaymentMethodValidateBeforeCall(id, paymentMethodUpdateInput, include, null);
        Type localVarReturnType = new TypeToken<PaymentMethod>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updatePaymentMethodAsync(UUID id, PaymentMethodUpdateInput paymentMethodUpdateInput, List<String> include, final ApiCallback<PaymentMethod> _callback) throws ApiException {

        okhttp3.Call localVarCall = updatePaymentMethodValidateBeforeCall(id, paymentMethodUpdateInput, include, _callback);
        Type localVarReturnType = new TypeToken<PaymentMethod>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
