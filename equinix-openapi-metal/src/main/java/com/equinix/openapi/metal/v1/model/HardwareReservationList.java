...
public class HardwareReservationList {
  ...
  private List<HardwareReservation> hardwareReservations;
  ...
  **/
   ...
   * @return the HardwareReservationList instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to HardwareReservationList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HardwareReservationList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("hardware_reservations") != null && !jsonObj.get("hardware_reservations").isJsonNull()) {
        ...
        if (jsonArrayhardwareReservations != null) {
          ...
          for (int i = 0; i < jsonArrayhardwareReservations.size(); i++) {
            HardwareReservation.validateJsonElement(jsonArrayhardwareReservations.get(i));
          };
        }
      }
