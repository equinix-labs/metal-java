...
public class PortVlanAssignmentBatchVlanAssignmentsInner {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PortVlanAssignmentBatchVlanAssignmentsInner
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PortVlanAssignmentBatchVlanAssignmentsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
