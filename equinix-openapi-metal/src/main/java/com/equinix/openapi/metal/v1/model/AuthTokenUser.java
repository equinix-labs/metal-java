...
public class AuthTokenUser {
  ...
  * @throws IOException if the JSON Element is invalid with respect to AuthTokenUser
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthTokenUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
