...
public class SSHKeyCreateInput {
  ...
  **/
  ...
  public SSHKeyCreateInput tags(List<String> tags) {
    
    this.tags = tags;
    return this;
  }

  public SSHKeyCreateInput addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.instancesIds, ssHKeyCreateInput.instancesIds) &&
        ...
        Objects.equals(this.tags, ssHKeyCreateInput.tags)&&
        Objects.equals(this.additionalProperties, ssHKeyCreateInput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(instancesIds, key, label, tags, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to SSHKeyCreateInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SSHKeyCreateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
