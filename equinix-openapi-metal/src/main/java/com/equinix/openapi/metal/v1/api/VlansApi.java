...
public class VlansApi {
     ...
     */
    public okhttp3.Call deleteVirtualNetworkCall(UUID id, List<String> include, List<String> exclude, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteVirtualNetworkValidateBeforeCall(UUID id, List<String> include, List<String> exclude, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling deleteVirtualNetwork(Async)");
        }

        return deleteVirtualNetworkCall(id, include, exclude, _callback);
     ...
     */
    public VirtualNetwork deleteVirtualNetwork(UUID id, List<String> include, List<String> exclude) throws ApiException {
        ApiResponse<VirtualNetwork> localVarResp = deleteVirtualNetworkWithHttpInfo(id, include, exclude);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<VirtualNetwork> deleteVirtualNetworkWithHttpInfo(UUID id, List<String> include, List<String> exclude) throws ApiException {
        okhttp3.Call localVarCall = deleteVirtualNetworkValidateBeforeCall(id, include, exclude, null);
        Type localVarReturnType = new TypeToken<VirtualNetwork>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call deleteVirtualNetworkAsync(UUID id, List<String> include, List<String> exclude, final ApiCallback<VirtualNetwork> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteVirtualNetworkValidateBeforeCall(id, include, exclude, _callback);
        Type localVarReturnType = new TypeToken<VirtualNetwork>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getVirtualNetworkCall(UUID id, List<String> include, List<String> exclude, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getVirtualNetworkValidateBeforeCall(UUID id, List<String> include, List<String> exclude, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getVirtualNetwork(Async)");
        }

        return getVirtualNetworkCall(id, include, exclude, _callback);
     ...
     */
    public VirtualNetwork getVirtualNetwork(UUID id, List<String> include, List<String> exclude) throws ApiException {
        ApiResponse<VirtualNetwork> localVarResp = getVirtualNetworkWithHttpInfo(id, include, exclude);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<VirtualNetwork> getVirtualNetworkWithHttpInfo(UUID id, List<String> include, List<String> exclude) throws ApiException {
        okhttp3.Call localVarCall = getVirtualNetworkValidateBeforeCall(id, include, exclude, null);
        Type localVarReturnType = new TypeToken<VirtualNetwork>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getVirtualNetworkAsync(UUID id, List<String> include, List<String> exclude, final ApiCallback<VirtualNetwork> _callback) throws ApiException {

        okhttp3.Call localVarCall = getVirtualNetworkValidateBeforeCall(id, include, exclude, _callback);
        Type localVarReturnType = new TypeToken<VirtualNetwork>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
