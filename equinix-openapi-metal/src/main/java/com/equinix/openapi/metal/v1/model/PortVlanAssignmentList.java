...
public class PortVlanAssignmentList {
  ...
  **/
   ...
   * @return the PortVlanAssignmentList instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to PortVlanAssignmentList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PortVlanAssignmentList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("vlan_assignments") != null && !jsonObj.get("vlan_assignments").isJsonNull()) {
        ...
        if (jsonArrayvlanAssignments != null) {
          ...
          for (int i = 0; i < jsonArrayvlanAssignments.size(); i++) {
            PortVlanAssignment.validateJsonElement(jsonArrayvlanAssignments.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PortVlanAssignmentList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PortVlanAssignmentList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PortVlanAssignmentList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PortVlanAssignmentList.class));

       return (TypeAdapter<T>) new TypeAdapter<PortVlanAssignmentList>() {
           @Override
 ...
 /**
  * Create an instance of PortVlanAssignmentList given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PortVlanAssignmentList
  * @throws IOException if the JSON string is invalid with respect to PortVlanAssignmentList
  */
  public static PortVlanAssignmentList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PortVlanAssignmentList.class);
  }

 /**
  * Convert an instance of PortVlanAssignmentList to an JSON string
  *
  * @return JSON string
  */
