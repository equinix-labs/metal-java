...
public class VlanVirtualCircuitUpdateInput {
  ...
  * @throws IOException if the JSON Element is invalid with respect to VlanVirtualCircuitUpdateInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VlanVirtualCircuitUpdateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
