...
public class DeviceUpdateInput {
  ...
  * @throws IOException if the JSON Element is invalid with respect to DeviceUpdateInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeviceUpdateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
