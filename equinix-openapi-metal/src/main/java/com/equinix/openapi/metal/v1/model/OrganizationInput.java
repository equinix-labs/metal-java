...
public class OrganizationInput {
  ...
  * @throws IOException if the JSON Element is invalid with respect to OrganizationInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrganizationInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
