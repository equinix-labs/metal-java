...
public class PortConvertLayer3Input {
  public static final String SERIALIZED_NAME_REQUEST_IPS = "request_ips";
  @SerializedName(SERIALIZED_NAME_REQUEST_IPS)
  private List<PortConvertLayer3InputRequestIpsInner> requestIps;
  ...
  public PortConvertLayer3Input addRequestIpsItem(PortConvertLayer3InputRequestIpsInner requestIpsItem) {
    if (this.requestIps == null) {
      this.requestIps = new ArrayList<>();
    }
  ...
  **/
  ...
  public List<PortConvertLayer3InputRequestIpsInner> getRequestIps() {
    return requestIps;
  }


  public void setRequestIps(List<PortConvertLayer3InputRequestIpsInner> requestIps) {
    this.requestIps = requestIps;
  }
   ...
   * @return the PortConvertLayer3Input instance itself
   */
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PortConvertLayer3Input.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PortConvertLayer3Input' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PortConvertLayer3Input> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PortConvertLayer3Input.class));

       return (TypeAdapter<T>) new TypeAdapter<PortConvertLayer3Input>() {
           @Override
 ...
 /**
  * Create an instance of PortConvertLayer3Input given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PortConvertLayer3Input
  * @throws IOException if the JSON string is invalid with respect to PortConvertLayer3Input
  */
  public static PortConvertLayer3Input fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PortConvertLayer3Input.class);
  }

 /**
  * Convert an instance of PortConvertLayer3Input to an JSON string
  *
  * @return JSON string
  */
