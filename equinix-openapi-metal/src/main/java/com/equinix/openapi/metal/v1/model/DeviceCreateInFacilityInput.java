...
public class DeviceCreateInFacilityInput {
  ...
  public DeviceCreateInFacilityInput() {
  }

  @Deprecated
  public DeviceCreateInFacilityInput facility(List<String> facility) {
    
    this.facility = facility;
    return this;
  }

  public DeviceCreateInFacilityInput addFacilityItem(String facilityItem) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput alwaysPxe(Boolean alwaysPxe) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput billingCycle(BillingCycleEnum billingCycle) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput customdata(Map<String, Object> customdata) {
    
    this.customdata = customdata;
    return this;
  }

  public DeviceCreateInFacilityInput putCustomdataItem(String key, Object customdataItem) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput description(String description) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput features(List<String> features) {
    
    this.features = features;
    return this;
  }

  public DeviceCreateInFacilityInput addFeaturesItem(String featuresItem) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput hardwareReservationId(String hardwareReservationId) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput hostname(String hostname) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput ipAddresses(List<IPAddress> ipAddresses) {
    
    this.ipAddresses = ipAddresses;
    return this;
  }

  public DeviceCreateInFacilityInput addIpAddressesItem(IPAddress ipAddressesItem) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput ipxeScriptUrl(String ipxeScriptUrl) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput locked(Boolean locked) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput networkFrozen(Boolean networkFrozen) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput noSshKeys(Boolean noSshKeys) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput operatingSystem(String operatingSystem) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput plan(String plan) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput privateIpv4SubnetSize(Integer privateIpv4SubnetSize) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput projectSshKeys(List<UUID> projectSshKeys) {
    
    this.projectSshKeys = projectSshKeys;
    return this;
  }

  public DeviceCreateInFacilityInput addProjectSshKeysItem(UUID projectSshKeysItem) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput publicIpv4SubnetSize(Integer publicIpv4SubnetSize) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput spotInstance(Boolean spotInstance) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput spotPriceMax(Float spotPriceMax) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput sshKeys(List<SSHKeyInput> sshKeys) {
    
    this.sshKeys = sshKeys;
    return this;
  }

  public DeviceCreateInFacilityInput addSshKeysItem(SSHKeyInput sshKeysItem) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput storage(Storage storage) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput tags(List<String> tags) {
    
    this.tags = tags;
    return this;
  }

  public DeviceCreateInFacilityInput addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput terminationTime(OffsetDateTime terminationTime) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput userSshKeys(List<UUID> userSshKeys) {
    
    this.userSshKeys = userSshKeys;
    return this;
  }

  public DeviceCreateInFacilityInput addUserSshKeysItem(UUID userSshKeysItem) {
  ...
  **/
  ...
  public DeviceCreateInFacilityInput userdata(String userdata) {
  ...
  **/
   ...
   * @return the DeviceCreateInFacilityInput instance itself
   */
  public DeviceCreateInFacilityInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DeviceCreateInFacilityInput deviceCreateInFacilityInput = (DeviceCreateInFacilityInput) o;
    return Objects.equals(this.facility, deviceCreateInFacilityInput.facility) &&
        Objects.equals(this.alwaysPxe, deviceCreateInFacilityInput.alwaysPxe) &&
        Objects.equals(this.billingCycle, deviceCreateInFacilityInput.billingCycle) &&
        Objects.equals(this.customdata, deviceCreateInFacilityInput.customdata) &&
        Objects.equals(this.description, deviceCreateInFacilityInput.description) &&
        Objects.equals(this.features, deviceCreateInFacilityInput.features) &&
        Objects.equals(this.hardwareReservationId, deviceCreateInFacilityInput.hardwareReservationId) &&
        Objects.equals(this.hostname, deviceCreateInFacilityInput.hostname) &&
        Objects.equals(this.ipAddresses, deviceCreateInFacilityInput.ipAddresses) &&
        Objects.equals(this.ipxeScriptUrl, deviceCreateInFacilityInput.ipxeScriptUrl) &&
        Objects.equals(this.locked, deviceCreateInFacilityInput.locked) &&
        Objects.equals(this.networkFrozen, deviceCreateInFacilityInput.networkFrozen) &&
        Objects.equals(this.noSshKeys, deviceCreateInFacilityInput.noSshKeys) &&
        Objects.equals(this.operatingSystem, deviceCreateInFacilityInput.operatingSystem) &&
        Objects.equals(this.plan, deviceCreateInFacilityInput.plan) &&
        Objects.equals(this.privateIpv4SubnetSize, deviceCreateInFacilityInput.privateIpv4SubnetSize) &&
        Objects.equals(this.projectSshKeys, deviceCreateInFacilityInput.projectSshKeys) &&
        Objects.equals(this.publicIpv4SubnetSize, deviceCreateInFacilityInput.publicIpv4SubnetSize) &&
        Objects.equals(this.spotInstance, deviceCreateInFacilityInput.spotInstance) &&
        Objects.equals(this.spotPriceMax, deviceCreateInFacilityInput.spotPriceMax) &&
        Objects.equals(this.sshKeys, deviceCreateInFacilityInput.sshKeys) &&
        Objects.equals(this.storage, deviceCreateInFacilityInput.storage) &&
        Objects.equals(this.tags, deviceCreateInFacilityInput.tags) &&
        Objects.equals(this.terminationTime, deviceCreateInFacilityInput.terminationTime) &&
        Objects.equals(this.userSshKeys, deviceCreateInFacilityInput.userSshKeys) &&
        Objects.equals(this.userdata, deviceCreateInFacilityInput.userdata)&&
        Objects.equals(this.additionalProperties, deviceCreateInFacilityInput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(facility, alwaysPxe, billingCycle, customdata, description, features, hardwareReservationId, hostname, ipAddresses, ipxeScriptUrl, locked, networkFrozen, noSshKeys, operatingSystem, plan, privateIpv4SubnetSize, projectSshKeys, publicIpv4SubnetSize, spotInstance, spotPriceMax, sshKeys, storage, tags, terminationTime, userSshKeys, userdata, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeviceCreateInFacilityInput {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to DeviceCreateInFacilityInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeviceCreateInFacilityInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeviceCreateInFacilityInput is not found in the empty JSON string", DeviceCreateInFacilityInput.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeviceCreateInFacilityInput.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeviceCreateInFacilityInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeviceCreateInFacilityInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeviceCreateInFacilityInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeviceCreateInFacilityInput.class));

       return (TypeAdapter<T>) new TypeAdapter<DeviceCreateInFacilityInput>() {
           @Override
           public void write(JsonWriter out, DeviceCreateInFacilityInput value) throws IOException {
           ...
           @Override
           public DeviceCreateInFacilityInput read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             DeviceCreateInFacilityInput instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DeviceCreateInFacilityInput given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DeviceCreateInFacilityInput
  * @throws IOException if the JSON string is invalid with respect to DeviceCreateInFacilityInput
  */
  public static DeviceCreateInFacilityInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeviceCreateInFacilityInput.class);
  }

 /**
  * Convert an instance of DeviceCreateInFacilityInput to an JSON string
  *
  * @return JSON string
  */
