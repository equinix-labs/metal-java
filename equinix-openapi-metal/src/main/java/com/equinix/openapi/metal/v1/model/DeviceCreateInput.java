...
public class DeviceCreateInput {
  ...
  **/
  ...
  public DeviceCreateInput ipAddresses(List<IPAddress> ipAddresses) {
    
    this.ipAddresses = ipAddresses;
    return this;
  }

  public DeviceCreateInput addIpAddressesItem(IPAddress ipAddressesItem) {
  ...
  **/
  ...
  public DeviceCreateInput privateIpv4SubnetSize(Integer privateIpv4SubnetSize) {
  ...
  **/
  ...
  public DeviceCreateInput storage(Storage storage) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.alwaysPxe, deviceCreateInput.alwaysPxe) &&
        ...
        Objects.equals(this.storage, deviceCreateInput.storage) &&
  ...
  * @throws IOException if the JSON Element is invalid with respect to DeviceCreateInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeviceCreateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
