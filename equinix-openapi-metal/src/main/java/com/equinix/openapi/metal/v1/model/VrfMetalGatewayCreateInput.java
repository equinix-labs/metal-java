...
public class VrfMetalGatewayCreateInput {
  ...
  **/
   ...
   * @return the VrfMetalGatewayCreateInput instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to VrfMetalGatewayCreateInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VrfMetalGatewayCreateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
