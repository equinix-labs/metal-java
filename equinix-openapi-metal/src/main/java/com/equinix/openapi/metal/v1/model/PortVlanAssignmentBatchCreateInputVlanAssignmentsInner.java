...
public class PortVlanAssignmentBatchCreateInputVlanAssignmentsInner {
  ...
  **/
   ...
   * @return the PortVlanAssignmentBatchCreateInputVlanAssignmentsInner instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to PortVlanAssignmentBatchCreateInputVlanAssignmentsInner
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PortVlanAssignmentBatchCreateInputVlanAssignmentsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
