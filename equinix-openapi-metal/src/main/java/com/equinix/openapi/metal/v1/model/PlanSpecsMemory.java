...
public class PlanSpecsMemory {
  ...
  * @throws IOException if the JSON Element is invalid with respect to PlanSpecsMemory
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlanSpecsMemory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
