...
public class ProjectUsageList {
  ...
  private List<ProjectUsage> usages;
  ...
  **/
   ...
   * @return the ProjectUsageList instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to ProjectUsageList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectUsageList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("usages") != null && !jsonObj.get("usages").isJsonNull()) {
        ...
        if (jsonArrayusages != null) {
          ...
          for (int i = 0; i < jsonArrayusages.size(); i++) {
            ProjectUsage.validateJsonElement(jsonArrayusages.get(i));
          };
        }
      }
  }
