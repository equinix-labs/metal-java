...
public class IPAssignmentInput {
  ...
  **/
   ...
   * @return the IPAssignmentInput instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to IPAssignmentInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IPAssignmentInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IPAssignmentInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IPAssignmentInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IPAssignmentInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IPAssignmentInput.class));

       return (TypeAdapter<T>) new TypeAdapter<IPAssignmentInput>() {
           @Override
 ...
 /**
  * Create an instance of IPAssignmentInput given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IPAssignmentInput
  * @throws IOException if the JSON string is invalid with respect to IPAssignmentInput
  */
  public static IPAssignmentInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IPAssignmentInput.class);
  }

 /**
  * Convert an instance of IPAssignmentInput to an JSON string
  *
  * @return JSON string
  */
