...
public class TransferRequestInput {
  ...
  * @throws IOException if the JSON Object is invalid with respect to TransferRequestInput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TransferRequestInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
