...
public class TransferRequestInput {
  ...
  **/
   ...
   * @return the TransferRequestInput instance itself
   */
  ...
  static {
    ...
    openapiFields.add("target_organization_id");
  ...
  * @throws IOException if the JSON Element is invalid with respect to TransferRequestInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransferRequestInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransferRequestInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransferRequestInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransferRequestInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransferRequestInput.class));

       return (TypeAdapter<T>) new TypeAdapter<TransferRequestInput>() {
           @Override
 ...
 /**
  * Create an instance of TransferRequestInput given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TransferRequestInput
  * @throws IOException if the JSON string is invalid with respect to TransferRequestInput
  */
  public static TransferRequestInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransferRequestInput.class);
  }

 /**
  * Convert an instance of TransferRequestInput to an JSON string
  *
  * @return JSON string
  */
