...
public class PlansApi {
     ...
     */
    public okhttp3.Call findPlansCall(List<String> include, List<String> exclude, final ApiCallback _callback) throws ApiException {
    ...
    public PlanList findPlans(List<String> include, List<String> exclude) throws ApiException {
        ApiResponse<PlanList> localVarResp = findPlansWithHttpInfo(include, exclude);
    ...
    public ApiResponse<PlanList> findPlansWithHttpInfo(List<String> include, List<String> exclude) throws ApiException {
        okhttp3.Call localVarCall = findPlansValidateBeforeCall(include, exclude, null);
     ...
     */
    public okhttp3.Call findPlansAsync(List<String> include, List<String> exclude, final ApiCallback<PlanList> _callback) throws ApiException {

        okhttp3.Call localVarCall = findPlansValidateBeforeCall(include, exclude, _callback);
        Type localVarReturnType = new TypeToken<PlanList>(){}.getType();
