...
public class AuthTokenList {
  ...
  private List<AuthToken> apiKeys;
  ...
  **/
   ...
   * @return the AuthTokenList instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to AuthTokenList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthTokenList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("api_keys") != null && !jsonObj.get("api_keys").isJsonNull()) {
        ...
        if (jsonArrayapiKeys != null) {
          ...
          for (int i = 0; i < jsonArrayapiKeys.size(); i++) {
            AuthToken.validateJsonElement(jsonArrayapiKeys.get(i));
          };
        }
      }
  }
