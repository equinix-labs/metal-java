...
public class DeviceUsage {
  ...
  **/
   ...
   * @return the DeviceUsage instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to DeviceUsage
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeviceUsage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
