...
public class LicenseCreateInput {
  ...
  **/
   ...
   * @return the LicenseCreateInput instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to LicenseCreateInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LicenseCreateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
