...
public class ProjectCreateFromRootInput {
  ...
  **/
  ...
  public ProjectCreateFromRootInput type(TypeEnum type) {
  ...
  **/
   ...
   * @return the ProjectCreateFromRootInput instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customdata, projectCreateFromRootInput.customdata) &&
        ...
        Objects.equals(this.type, projectCreateFromRootInput.type) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(customdata, name, organizationId, paymentMethodId, type, tags, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ProjectCreateFromRootInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectCreateFromRootInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectCreateFromRootInput is not found in the empty JSON string", ProjectCreateFromRootInput.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectCreateFromRootInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectCreateFromRootInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectCreateFromRootInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectCreateFromRootInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectCreateFromRootInput>() {
           @Override
 ...
 /**
  * Create an instance of ProjectCreateFromRootInput given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProjectCreateFromRootInput
  * @throws IOException if the JSON string is invalid with respect to ProjectCreateFromRootInput
  */
  public static ProjectCreateFromRootInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectCreateFromRootInput.class);
  }

 /**
  * Convert an instance of ProjectCreateFromRootInput to an JSON string
  *
  * @return JSON string
  */
