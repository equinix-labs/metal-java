...
public class ProjectCreateFromRootInput {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProjectCreateFromRootInput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProjectCreateFromRootInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
