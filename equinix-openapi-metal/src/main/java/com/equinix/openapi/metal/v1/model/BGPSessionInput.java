...
public class BGPSessionInput {
  ...
  * @throws IOException if the JSON Element is invalid with respect to BGPSessionInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BGPSessionInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
