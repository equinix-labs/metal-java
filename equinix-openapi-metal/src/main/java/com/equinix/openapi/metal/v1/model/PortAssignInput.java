...
public class PortAssignInput {
  ...
  **/
   ...
   * @return the PortAssignInput instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to PortAssignInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PortAssignInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
