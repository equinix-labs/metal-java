...
public class CapacityList {
  ...
  private Map<String, Map<String, CapacityLevelPerBaremetal>> capacity = new HashMap<>();
  ...
  **/
   ...
   * @return the CapacityList instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to CapacityList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CapacityList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
