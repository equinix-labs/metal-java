...
public class SelfServiceReservationList {
  ...
  public SelfServiceReservationList addReservationsItem(SelfServiceReservationResponse reservationsItem) {
  ...
  **/
  ...
  public List<SelfServiceReservationResponse> getReservations() {
    return reservations;
  }


  public void setReservations(List<SelfServiceReservationResponse> reservations) {
    this.reservations = reservations;
  }
   ...
   * @return the SelfServiceReservationList instance itself
   */
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SelfServiceReservationList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SelfServiceReservationList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SelfServiceReservationList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SelfServiceReservationList.class));

       return (TypeAdapter<T>) new TypeAdapter<SelfServiceReservationList>() {
           @Override
 ...
 /**
  * Create an instance of SelfServiceReservationList given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SelfServiceReservationList
  * @throws IOException if the JSON string is invalid with respect to SelfServiceReservationList
  */
  public static SelfServiceReservationList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SelfServiceReservationList.class);
  }

 /**
  * Convert an instance of SelfServiceReservationList to an JSON string
  *
  * @return JSON string
  */
