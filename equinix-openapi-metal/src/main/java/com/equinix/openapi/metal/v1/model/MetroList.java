...
public class MetroList {
  ...
  **/
   ...
   * @return the MetroList instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to MetroList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetroList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
