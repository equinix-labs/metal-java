...
public class TransferRequestList {
  ...
  **/
   ...
   * @return the TransferRequestList instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to TransferRequestList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransferRequestList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("transfers") != null && !jsonObj.get("transfers").isJsonNull()) {
        ...
        if (jsonArraytransfers != null) {
          ...
          for (int i = 0; i < jsonArraytransfers.size(); i++) {
            TransferRequest.validateJsonElement(jsonArraytransfers.get(i));
          };
        }
      }
  }
