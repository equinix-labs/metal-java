...
public class ProjectUpdateInput {
  public static final String SERIALIZED_NAME_BACKEND_TRANSFER_ENABLED = "backend_transfer_enabled";
  @SerializedName(SERIALIZED_NAME_BACKEND_TRANSFER_ENABLED)
  private Boolean backendTransferEnabled;
  ...
  **/
  ...
  public ProjectUpdateInput tags(List<String> tags) {
    
    this.tags = tags;
    return this;
  }

  public ProjectUpdateInput addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
   ...
   * @return the ProjectUpdateInput instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.backendTransferEnabled, projectUpdateInput.backendTransferEnabled) &&
        ...
        Objects.equals(this.tags, projectUpdateInput.tags)&&
        Objects.equals(this.additionalProperties, projectUpdateInput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(backendTransferEnabled, customdata, name, paymentMethodId, tags, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("backend_transfer_enabled");
  ...
  * @throws IOException if the JSON Element is invalid with respect to ProjectUpdateInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectUpdateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectUpdateInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectUpdateInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectUpdateInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectUpdateInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectUpdateInput>() {
           @Override
 ...
 /**
  * Create an instance of ProjectUpdateInput given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProjectUpdateInput
  * @throws IOException if the JSON string is invalid with respect to ProjectUpdateInput
  */
  public static ProjectUpdateInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectUpdateInput.class);
  }

 /**
  * Convert an instance of ProjectUpdateInput to an JSON string
  *
  * @return JSON string
  */
