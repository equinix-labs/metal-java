...
public class VrfFabricVcCreateInput {
  ...
  * @throws IOException if the JSON Element is invalid with respect to VrfFabricVcCreateInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VrfFabricVcCreateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
