...
public class CreateSelfServiceReservationRequest {
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSelfServiceReservationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSelfServiceReservationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSelfServiceReservationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSelfServiceReservationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSelfServiceReservationRequest>() {
           @Override
 ...
 /**
  * Create an instance of CreateSelfServiceReservationRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateSelfServiceReservationRequest
  * @throws IOException if the JSON string is invalid with respect to CreateSelfServiceReservationRequest
  */
  public static CreateSelfServiceReservationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSelfServiceReservationRequest.class);
  }

 /**
  * Convert an instance of CreateSelfServiceReservationRequest to an JSON string
  *
  * @return JSON string
  */
