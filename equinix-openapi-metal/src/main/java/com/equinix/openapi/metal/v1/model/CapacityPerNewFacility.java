...
public class CapacityPerNewFacility {
  ...
  **/
   ...
   * @return the CapacityPerNewFacility instance itself
   */
  ...
  * @throws IOException if the JSON Object is invalid with respect to CapacityPerNewFacility
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CapacityPerNewFacility.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CapacityPerNewFacility.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CapacityPerNewFacility' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CapacityPerNewFacility> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CapacityPerNewFacility.class));

       return (TypeAdapter<T>) new TypeAdapter<CapacityPerNewFacility>() {
           @Override
 ...
 /**
  * Create an instance of CapacityPerNewFacility given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CapacityPerNewFacility
  * @throws IOException if the JSON string is invalid with respect to CapacityPerNewFacility
  */
  public static CapacityPerNewFacility fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CapacityPerNewFacility.class);
  }

 /**
  * Convert an instance of CapacityPerNewFacility to an JSON string
  *
  * @return JSON string
  */
