...
public class PaymentMethodList {
  ...
  public PaymentMethodList addPaymentMethodsItem(PaymentMethod paymentMethodsItem) {
  ...
  **/
   ...
   * @return the PaymentMethodList instance itself
   */
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymentMethodList
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymentMethodList.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PaymentMethodList>() {
           @Override
