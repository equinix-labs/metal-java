...
public class VirtualCircuitList {
  ...
  * @throws IOException if the JSON Element is invalid with respect to VirtualCircuitList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VirtualCircuitList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
