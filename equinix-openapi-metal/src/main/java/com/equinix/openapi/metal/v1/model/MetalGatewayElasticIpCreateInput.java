...
public class MetalGatewayElasticIpCreateInput {
  ...
  * @throws IOException if the JSON Element is invalid with respect to MetalGatewayElasticIpCreateInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetalGatewayElasticIpCreateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
