...
public class GlobalBgpRange {
  ...
  **/
   ...
   * @return the GlobalBgpRange instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to GlobalBgpRange
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GlobalBgpRange.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
