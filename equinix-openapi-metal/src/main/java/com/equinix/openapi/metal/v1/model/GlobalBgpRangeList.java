...
public class GlobalBgpRangeList {
  ...
  public GlobalBgpRangeList addGlobalBgpRangesItem(GlobalBgpRange globalBgpRangesItem) {
    if (this.globalBgpRanges == null) {
      this.globalBgpRanges = new ArrayList<>();
    }
  ...
  **/
   ...
   * @return the GlobalBgpRangeList instance itself
   */
  ...
  static {
    ...
    openapiFields.add("global_bgp_ranges");
  ...
  * @throws IOException if the JSON Element is invalid with respect to GlobalBgpRangeList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GlobalBgpRangeList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("global_bgp_ranges") != null && !jsonObj.get("global_bgp_ranges").isJsonNull()) {
        ...
        if (jsonArrayglobalBgpRanges != null) {
          ...
          for (int i = 0; i < jsonArrayglobalBgpRanges.size(); i++) {
            GlobalBgpRange.validateJsonElement(jsonArrayglobalBgpRanges.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GlobalBgpRangeList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GlobalBgpRangeList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GlobalBgpRangeList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GlobalBgpRangeList.class));

       return (TypeAdapter<T>) new TypeAdapter<GlobalBgpRangeList>() {
           @Override
 ...
 /**
  * Create an instance of GlobalBgpRangeList given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GlobalBgpRangeList
  * @throws IOException if the JSON string is invalid with respect to GlobalBgpRangeList
  */
  public static GlobalBgpRangeList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GlobalBgpRangeList.class);
  }

 /**
  * Convert an instance of GlobalBgpRangeList to an JSON string
  *
  * @return JSON string
  */
