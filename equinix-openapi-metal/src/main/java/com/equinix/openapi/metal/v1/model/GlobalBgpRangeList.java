...
public class GlobalBgpRangeList {
  ...
  * @throws IOException if the JSON Object is invalid with respect to GlobalBgpRangeList
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GlobalBgpRangeList.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
