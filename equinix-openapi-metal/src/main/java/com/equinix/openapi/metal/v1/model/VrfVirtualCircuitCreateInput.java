...
public class VrfVirtualCircuitCreateInput {
  ...
  * @throws IOException if the JSON Element is invalid with respect to VrfVirtualCircuitCreateInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VrfVirtualCircuitCreateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
