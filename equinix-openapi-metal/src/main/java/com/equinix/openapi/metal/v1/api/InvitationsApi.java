...
public class InvitationsApi {
     ...
     */
    public okhttp3.Call acceptInvitationCall(UUID id, List<String> include, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call acceptInvitationValidateBeforeCall(UUID id, List<String> include, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling acceptInvitation(Async)");
        }

        return acceptInvitationCall(id, include, _callback);
     ...
     */
    public Membership acceptInvitation(UUID id, List<String> include) throws ApiException {
        ApiResponse<Membership> localVarResp = acceptInvitationWithHttpInfo(id, include);
     ...
     */
    public ApiResponse<Membership> acceptInvitationWithHttpInfo(UUID id, List<String> include) throws ApiException {
        okhttp3.Call localVarCall = acceptInvitationValidateBeforeCall(id, include, null);
     ...
     */
    public okhttp3.Call acceptInvitationAsync(UUID id, List<String> include, final ApiCallback<Membership> _callback) throws ApiException {

        okhttp3.Call localVarCall = acceptInvitationValidateBeforeCall(id, include, _callback);
        Type localVarReturnType = new TypeToken<Membership>(){}.getType();
     ...
     */
    public okhttp3.Call findInvitationByIdCall(UUID id, List<String> include, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call findInvitationByIdValidateBeforeCall(UUID id, List<String> include, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling findInvitationById(Async)");
        }

        return findInvitationByIdCall(id, include, _callback);
     ...
     */
    public Invitation findInvitationById(UUID id, List<String> include) throws ApiException {
        ApiResponse<Invitation> localVarResp = findInvitationByIdWithHttpInfo(id, include);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Invitation> findInvitationByIdWithHttpInfo(UUID id, List<String> include) throws ApiException {
        okhttp3.Call localVarCall = findInvitationByIdValidateBeforeCall(id, include, null);
     ...
     */
    public okhttp3.Call findInvitationByIdAsync(UUID id, List<String> include, final ApiCallback<Invitation> _callback) throws ApiException {

        okhttp3.Call localVarCall = findInvitationByIdValidateBeforeCall(id, include, _callback);
        Type localVarReturnType = new TypeToken<Invitation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
