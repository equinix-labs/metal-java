...
public class PortVlanAssignment {
  ...
  **/
   ...
   * @return the PortVlanAssignment instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to PortVlanAssignment
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PortVlanAssignment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
