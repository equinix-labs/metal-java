...
public class InterconnectionList {
  ...
  * @throws IOException if the JSON Element is invalid with respect to InterconnectionList
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InterconnectionList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("interconnections") != null && !jsonObj.get("interconnections").isJsonNull()) {
        ...
        if (jsonArrayinterconnections != null) {
          ...
          for (int i = 0; i < jsonArrayinterconnections.size(); i++) {
            Interconnection.validateJsonElement(jsonArrayinterconnections.get(i));
          };
        }
      }
