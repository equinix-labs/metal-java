...
public class VrfIpReservationCreateInput {
  ...
  * @throws IOException if the JSON Element is invalid with respect to VrfIpReservationCreateInput
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VrfIpReservationCreateInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
