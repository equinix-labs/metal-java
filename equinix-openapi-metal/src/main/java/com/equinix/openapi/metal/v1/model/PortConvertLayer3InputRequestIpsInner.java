...
public class PortConvertLayer3InputRequestIpsInner {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PortConvertLayer3InputRequestIpsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PortConvertLayer3InputRequestIpsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
