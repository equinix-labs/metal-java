...
public class PortConvertLayer3InputRequestIpsInner {
  ...
  **/
  ...
  public PortConvertLayer3InputRequestIpsInner _public(Boolean _public) {
  ...
  **/
   ...
   * @return the PortConvertLayer3InputRequestIpsInner instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to PortConvertLayer3InputRequestIpsInner
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PortConvertLayer3InputRequestIpsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PortConvertLayer3InputRequestIpsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PortConvertLayer3InputRequestIpsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PortConvertLayer3InputRequestIpsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PortConvertLayer3InputRequestIpsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<PortConvertLayer3InputRequestIpsInner>() {
           @Override
 ...
 /**
  * Create an instance of PortConvertLayer3InputRequestIpsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PortConvertLayer3InputRequestIpsInner
  * @throws IOException if the JSON string is invalid with respect to PortConvertLayer3InputRequestIpsInner
  */
  public static PortConvertLayer3InputRequestIpsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PortConvertLayer3InputRequestIpsInner.class);
  }

 /**
  * Convert an instance of PortConvertLayer3InputRequestIpsInner to an JSON string
  *
  * @return JSON string
  */
