...
public class VrfsApi {
     ...
     */
    public okhttp3.Call updateVrfCall(UUID id, VrfUpdateInput vrfUpdateInput, List<String> include, List<String> exclude, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateVrfValidateBeforeCall(UUID id, VrfUpdateInput vrfUpdateInput, List<String> include, List<String> exclude, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
        ...
        return updateVrfCall(id, vrfUpdateInput, include, exclude, _callback);
     ...
     */
    public Vrf updateVrf(UUID id, VrfUpdateInput vrfUpdateInput, List<String> include, List<String> exclude) throws ApiException {
        ApiResponse<Vrf> localVarResp = updateVrfWithHttpInfo(id, vrfUpdateInput, include, exclude);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Vrf> updateVrfWithHttpInfo(UUID id, VrfUpdateInput vrfUpdateInput, List<String> include, List<String> exclude) throws ApiException {
        okhttp3.Call localVarCall = updateVrfValidateBeforeCall(id, vrfUpdateInput, include, exclude, null);
        Type localVarReturnType = new TypeToken<Vrf>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateVrfAsync(UUID id, VrfUpdateInput vrfUpdateInput, List<String> include, List<String> exclude, final ApiCallback<Vrf> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateVrfValidateBeforeCall(id, vrfUpdateInput, include, exclude, _callback);
        Type localVarReturnType = new TypeToken<Vrf>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
