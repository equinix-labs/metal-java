...
public class MetalGatewaysApiTest {
    ...
    public void createMetalGatewayElasticIpTest() throws ApiException {
        ...
        List<String> include = null;
        List<String> exclude = null;
        IPAssignment response = api.createMetalGatewayElasticIp(id, metalGatewayElasticIpCreateInput, include, exclude);
        // TODO: test validations
    }
    ...
    public void deleteMetalGatewayTest() throws ApiException {
        ...
        List<String> include = null;
        List<String> exclude = null;
        FindMetalGatewayById200Response response = api.deleteMetalGateway(id, include, exclude);
        // TODO: test validations
    }
