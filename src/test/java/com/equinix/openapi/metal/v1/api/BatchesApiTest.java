...
public class BatchesApiTest {
    ...
    public void createDeviceBatchTest() throws Exception {
        UUID id = null;
        Body27 body = null;
        InlineResponse20037 response = api.createDeviceBatch(id, body);
    ...
    public void findBatchByIdTest() throws Exception {
        ...
        InlineResponse200 response = api.findBatchById(id, include, exclude);
    ...
    public void findBatchesByProjectTest() throws Exception {
        ...
        List<String> include = null;
        List<String> exclude = null;
        InlineResponse20037 response = api.findBatchesByProject(id, include, exclude);
