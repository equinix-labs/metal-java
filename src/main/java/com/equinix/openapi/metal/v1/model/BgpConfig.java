...
public class BgpConfig {
  ...
  **/
  ...
  public BgpConfig project(InlineResponse200Devices project) {
  ...
  **/
  ...
  public BgpConfig ranges(List<InlineResponse20038Ranges> ranges) {
    this.ranges = ranges;
    return this;
  }

  public BgpConfig addRangesItem(InlineResponse20038Ranges rangesItem) {
    if (this.ranges == null) {
  ...
  **/
  ...
  public BgpConfig sessions(List<InlineResponse2001> sessions) {
    this.sessions = sessions;
    return this;
  }

  public BgpConfig addSessionsItem(InlineResponse2001 sessionsItem) {
