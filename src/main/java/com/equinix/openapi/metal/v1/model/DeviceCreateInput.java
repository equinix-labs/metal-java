...
import com.equinix.openapi.metal.v1.model.DeviceCreateInputIpAddresses;
...
public class DeviceCreateInput {
  ...
  private List<Body38> sshKeys = null;
  ...
  **/
  ...
  public DeviceCreateInput sshKeys(List<Body38> sshKeys) {
    this.sshKeys = sshKeys;
    return this;
  }

  public DeviceCreateInput addSshKeysItem(Body38 sshKeysItem) {
    if (this.sshKeys == null) {
      this.sshKeys = new ArrayList<Body38>();
    }
  ...
  **/
  ...
  public List<Body38> getSshKeys() {
    return sshKeys;
  }

  public void setSshKeys(List<Body38> sshKeys) {
    this.sshKeys = sshKeys;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.tags, deviceCreateInput.tags) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, alwaysPxe, billingCycle, customdata, description, features, hardwareReservationId, hostname, ipAddresses, ipxeScriptUrl, locked, noSshKeys, operatingSystem, plan, privateIpv4SubnetSize, projectSshKeys, publicIpv4SubnetSize, spotInstance, spotPriceMax, sshKeys, terminationTime, userSshKeys, userdata);
  }
