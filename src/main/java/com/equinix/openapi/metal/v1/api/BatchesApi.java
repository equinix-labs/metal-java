...
import com.equinix.openapi.metal.v1.model.Body27;
import com.equinix.openapi.metal.v1.model.InlineResponse200;
import com.equinix.openapi.metal.v1.model.InlineResponse20037;
...
public class BatchesApi {
     ...
     */
    public com.squareup.okhttp.Call createDeviceBatchCall(UUID id, Body27 body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createDeviceBatchValidateBeforeCall(UUID id, Body27 body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling createDeviceBatch(Async)");
        }
        

        com.squareup.okhttp.Call call = createDeviceBatchCall(id, body, progressListener, progressRequestListener);
        return call;
     ...
     */
    public InlineResponse20037 createDeviceBatch(UUID id, Body27 body) throws ApiException {
        ApiResponse<InlineResponse20037> resp = createDeviceBatchWithHttpInfo(id, body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse20037> createDeviceBatchWithHttpInfo(UUID id, Body27 body) throws ApiException {
        com.squareup.okhttp.Call call = createDeviceBatchValidateBeforeCall(id, body, null, null);
     ...
     */
    public com.squareup.okhttp.Call createDeviceBatchAsync(UUID id, Body27 body, final ApiCallback<InlineResponse20037> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createDeviceBatchValidateBeforeCall(id, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse20037>(){}.getType();
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse200 findBatchById(UUID id, List<String> include, List<String> exclude) throws ApiException {
        ApiResponse<InlineResponse200> resp = findBatchByIdWithHttpInfo(id, include, exclude);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse200> findBatchByIdWithHttpInfo(UUID id, List<String> include, List<String> exclude) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call findBatchByIdAsync(UUID id, List<String> include, List<String> exclude, final ApiCallback<InlineResponse200> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse20037 findBatchesByProject(UUID id, List<String> include, List<String> exclude) throws ApiException {
        ApiResponse<InlineResponse20037> resp = findBatchesByProjectWithHttpInfo(id, include, exclude);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse20037> findBatchesByProjectWithHttpInfo(UUID id, List<String> include, List<String> exclude) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call findBatchesByProjectAsync(UUID id, List<String> include, List<String> exclude, final ApiCallback<InlineResponse20037> callback) throws ApiException {
