 ...
 */
@ApiModel(description = "A list of CIDR network addresses. Like [\"10.0.0.0/16\", \"2001:d78::/56\"].")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2022-07-20T13:48:24.543Z")
public class VrfIpRangeList extends ArrayList<String> {
  ...
  public String toString() {
    ...
    sb.append("class VrfIpRangeList {\n");
