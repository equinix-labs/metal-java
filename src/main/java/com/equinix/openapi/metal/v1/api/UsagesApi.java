...
public class UsagesApi {
     ...
     */
    public InlineResponse20015 findDeviceUsages(UUID id, String createdAfter, String createdBefore) throws ApiException {
        ApiResponse<InlineResponse20015> resp = findDeviceUsagesWithHttpInfo(id, createdAfter, createdBefore);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse20015> findDeviceUsagesWithHttpInfo(UUID id, String createdAfter, String createdBefore) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call findDeviceUsagesAsync(UUID id, String createdAfter, String createdBefore, final ApiCallback<InlineResponse20015> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse20044 findProjectUsage(UUID id, String createdAfter, String createdBefore) throws ApiException {
        ApiResponse<InlineResponse20044> resp = findProjectUsageWithHttpInfo(id, createdAfter, createdBefore);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse20044> findProjectUsageWithHttpInfo(UUID id, String createdAfter, String createdBefore) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call findProjectUsageAsync(UUID id, String createdAfter, String createdBefore, final ApiCallback<InlineResponse20044> callback) throws ApiException {
