...
public class User {
  ...
  **/
  ...
  public User addEmailsItem(Href emailsItem) {
    if (this.emails == null) {
      this.emails = new ArrayList<Href>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, user.id) &&
        ...
        Objects.equals(this.avatarThumbUrl, user.avatarThumbUrl) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, shortId, firstName, lastName, fullName, email, avatarUrl, avatarThumbUrl, twoFactorAuth, maxProjects, maxOrganizations, createdAt, updatedAt, timezone, fraudScore, lastLoginAt, emails, href, phoneNumber, customdata);
  }
