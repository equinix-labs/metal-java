...
public class HardwareReservationsApi {
    ...
    public Device findHardwareReservationById(UUID id, List<String> include, List<String> exclude) throws ApiException {
        ApiResponse<Device> resp = findHardwareReservationByIdWithHttpInfo(id, include, exclude);
        return resp.getData();
    }
     ...
     */
    public com.squareup.okhttp.Call findHardwareReservationByIdAsync(UUID id, List<String> include, List<String> exclude, final ApiCallback<Device> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call moveHardwareReservationCall(UUID id, UUID projectId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call moveHardwareReservationValidateBeforeCall(UUID id, UUID projectId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (projectId == null) {
            throw new ApiException("Missing the required parameter 'projectId' when calling moveHardwareReservation(Async)");
        }
        

        com.squareup.okhttp.Call call = moveHardwareReservationCall(id, projectId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public HardwareReservation moveHardwareReservation(UUID id, UUID projectId) throws ApiException {
        ApiResponse<HardwareReservation> resp = moveHardwareReservationWithHttpInfo(id, projectId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<HardwareReservation> moveHardwareReservationWithHttpInfo(UUID id, UUID projectId) throws ApiException {
        com.squareup.okhttp.Call call = moveHardwareReservationValidateBeforeCall(id, projectId, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call moveHardwareReservationAsync(UUID id, UUID projectId, final ApiCallback<HardwareReservation> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = moveHardwareReservationValidateBeforeCall(id, projectId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<HardwareReservation>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
