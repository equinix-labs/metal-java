...
public class FacilitiesApi {
   ...
   */
  public FacilityList findFacilities() throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/facilities".replaceAll("\\{format\\}","json");
    ...
    GenericType<FacilityList> localVarReturnType = new GenericType<FacilityList>() {};
