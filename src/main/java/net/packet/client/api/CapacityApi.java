...
public class CapacityApi {
   ...
   * @param facility Facility to create (required)
   * @throws ApiException if fails to make API call
   */
  public void checkCapacity(CapacityInput facility) throws ApiException {
    Object localVarPostBody = facility;
    
    // verify the required parameter 'facility' is set
    if (facility == null) {
      throw new ApiException(400, "Missing the required parameter 'facility' when calling checkCapacity");
    }
    
    // create path and map variables
    String localVarPath = "/capacity".replaceAll("\\{format\\}","json");
   ...
   * @throws ApiException if fails to make API call
   */
  public CapacityList findCapacity() throws ApiException {
    ...
    GenericType<CapacityList> localVarReturnType = new GenericType<CapacityList>() {};
