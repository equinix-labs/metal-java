...
public class MetalGatewaysApi {
     ...
     * @param metalGateway Metal Gateway to create (required)
     ...
     */
    public com.squareup.okhttp.Call createMetalGatewayCall(UUID projectId, MetalGatewayInput metalGateway, Integer page, Integer perPage, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = metalGateway;
    ...
    private com.squareup.okhttp.Call createMetalGatewayValidateBeforeCall(UUID projectId, MetalGatewayInput metalGateway, Integer page, Integer perPage, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // verify the required parameter 'metalGateway' is set
        if (metalGateway == null) {
            throw new ApiException("Missing the required parameter 'metalGateway' when calling createMetalGateway(Async)");
        }
        

        com.squareup.okhttp.Call call = createMetalGatewayCall(projectId, metalGateway, page, perPage, progressListener, progressRequestListener);
        return call;
     ...
     */
    public MetalGateway createMetalGateway(UUID projectId, MetalGatewayInput metalGateway, Integer page, Integer perPage) throws ApiException {
        ApiResponse<MetalGateway> resp = createMetalGatewayWithHttpInfo(projectId, metalGateway, page, perPage);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<MetalGateway> createMetalGatewayWithHttpInfo(UUID projectId, MetalGatewayInput metalGateway, Integer page, Integer perPage) throws ApiException {
        com.squareup.okhttp.Call call = createMetalGatewayValidateBeforeCall(projectId, metalGateway, page, perPage, null, null);
     ...
     */
    public com.squareup.okhttp.Call createMetalGatewayAsync(UUID projectId, MetalGatewayInput metalGateway, Integer page, Integer perPage, final ApiCallback<MetalGateway> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createMetalGatewayValidateBeforeCall(projectId, metalGateway, page, perPage, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<MetalGateway>(){}.getType();
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public MetalGateway findMetalGatewayById(UUID id) throws ApiException {
        ApiResponse<MetalGateway> resp = findMetalGatewayByIdWithHttpInfo(id);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<MetalGateway> findMetalGatewayByIdWithHttpInfo(UUID id) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call findMetalGatewayByIdAsync(UUID id, final ApiCallback<MetalGateway> callback) throws ApiException {
    ...
    public MetalGatewayList findMetalGatewaysByProject(UUID projectId, Integer page, Integer perPage) throws ApiException {
        ApiResponse<MetalGatewayList> resp = findMetalGatewaysByProjectWithHttpInfo(projectId, page, perPage);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call findMetalGatewaysByProjectAsync(UUID projectId, Integer page, Integer perPage, final ApiCallback<MetalGatewayList> callback) throws ApiException {
