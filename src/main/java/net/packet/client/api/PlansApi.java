...
public class PlansApi {
     ...
     */
    public PlanList findPlans(List<String> include, List<String> exclude) throws ApiException {
        ApiResponse<PlanList> resp = findPlansWithHttpInfo(include, exclude);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PlanList> findPlansWithHttpInfo(List<String> include, List<String> exclude) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call findPlansAsync(List<String> include, List<String> exclude, final ApiCallback<PlanList> callback) throws ApiException {
