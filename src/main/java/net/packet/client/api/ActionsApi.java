...
public class ActionsApi {
   ...
   */
  public void performAction(String id, String type) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling performAction");
    }
    
    // verify the required parameter 'type' is set
    if (type == null) {
      throw new ApiException(400, "Missing the required parameter 'type' when calling performAction");
    }
    
    // create path and map variables
    String localVarPath = "/devices/{id}/actions".replaceAll("\\{format\\}","json")
